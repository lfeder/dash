  ...
  const CONFIG = {
    ...
    row_plantings: {
      ...
      supabase: {
        ...
        select: 'org_site_gh_row_id,scenario,grow_variety_id,grow_variety_id_2,plants_per_bag',
        orderBy: 'org_site_gh_row_id',
        columns: [
